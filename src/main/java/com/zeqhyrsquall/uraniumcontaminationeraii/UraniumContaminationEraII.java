...
public class UraniumContaminationEraII {
    ...
    public UraniumContaminationEraII(IEventBus modEventBus, ModContainer modContainer) {
        // 注册中枢:全部方块/物品/方块实体/菜单/创造页/音效/粒子/数据组件经此提交(包结构说明 §2.1)
        ...
        // Note that this is necessary if and only if we want *this* class (UraniumContaminationEraII) to respond directly to events.
